    ...
    private void startGame(){
        ...
        countDownTimer = new CountDownTimer(6000,1000) {
            ...
            public void onFinish() {
                ...
                if(score > 200){
//                    Intent intent = new Intent(Level5Activity.this,ResultPage.class);
//                    intent.putExtra("score",score);
//                    startActivity(intent);
                    showLevelCompletion(score,pName);
                }
                else {
                    //show final score
    ...
    //========================================================================================
    private void showLevelCompletion(final int score,final String pName){

        //Using alertdialog to let user fill in name
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle("You has finished!!!");
        builder.setMessage("You have finish all the level \n with the score of " + score +
                "\n You can input your name");


        // put a edittext to let player input their name
        ...
        builder.setPositiveButton("Submit", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int which) {
                ...
                //get playername from the edittext
    ...
    private void exitNotification(){
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle("You has finished");
        builder.setMessage(" As your score: " + score + "\n is not reach the result line!!! \n Good luck next time ");
